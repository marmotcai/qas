...
class Encoder(nn.Module):
    ...
    def forward(self, X):
        ...
        for t in range(self.T - 1):
            ...
            x = torch.cat((h_n.repeat(self.input_size, 1, 1).permute(1, 0, 2), # torch.Size([1, 128, 128]) to torch.Size([128, 81, 128])
...
class DA_RNN(nn.Module):
    ...
    def __init__(self, X, y, T,
        ...
        if self.parallel: # 是否使用并行计算，用于具备多GPU并行计算
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            print("==> train epochs : ", epoch, "/", range(self.epochs))
            if self.shuffle:
            ...
            while (idx < self.train_timesteps):
                ...
                print("==> train idx : ", idx, " finish, loss : ", loss)
